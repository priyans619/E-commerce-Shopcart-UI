    ...
    <div className="border p-4 mb-4 flex items-center">
      <div className="flex-grow ml-2">
        ...
        <div className="flex items-center mt-4">
          <button onClick={() => onQuantityChange(-1)} className="bg-gray-200 rounded-full p-1">
            <AiOutlineMinus />
          </button>
      ...
      <div className="flex flex-col items-end ml-4">
        ...
        <button onClick={onRemove} className="border shadow-md border-b-gray-500 bg-gray-200 py-1 px-2 rounded mt-12">
          Remove item
        </button>
      </div>
    </div>
